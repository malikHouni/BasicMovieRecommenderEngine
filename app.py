...
movies=pd.read_csv('https://raw.githubusercontent.com/albertleecn/MovieLensDatasets/master/movies.dat',sep="::",encoding='latin',header=None,names=["MovieID","Title","Genres"])
ratings=pd.read_csv('https://raw.githubusercontent.com/albertleecn/MovieLensDatasets/master/ratings.dat',sep="::",encoding='latin',header=None,names=["UserID","MovieID","Rating","Timestamp"])
users=pd.read_csv('https://raw.githubusercontent.com/albertleecn/MovieLensDatasets/master/users.dat',sep="::",encoding='latin',header=None,names=["UserID","Gender","Age","Occupation","Zip-code"])
